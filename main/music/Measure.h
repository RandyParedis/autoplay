...
namespace music {
    ...
    public:
         ...
         */
        void setDivisions(const uint8_t& d) { assert(d != 0); m_divisions = d; }
        ...
        /**
         * Computes the maximal length of this Measure, based on its time and divisions signature
         * @return The max length of this Measure
         */
        unsigned int max_length() const;

        /**
         * Checks if total duration of all Notes of this Measure exceeds the length of one Measure
         * @return True if there are too much Notes in this Measure
         */
        bool isOverflowing() const;

        /**
         * Takes this Measure and creates a vector containing all Measures that were crammed in this one.
    ...
    private:
        ...
        uint8_t m_divisions;                    ///< The divisions value (amount of duration per quarter Note) for this Measure
    };
}
